    ...
    <div class="main">
        ...
        <div class="box">
            <van-row class="userheadimg">
                  ...
                  <van-col span="8">
                      <img :src="userinfo.headimg==null||userinfo.headimg==''?'static/images/morenheadimg.png':$HOST+userinfo.headimg" />
                  </van-col>
                  <van-col span="8">
                      <van-uploader :after-read="updateheadimg" accept="image/*" multiple>
            ...
            <van-row class="userheadimg">
                  ...
                  <van-col span="8">
                      <img :src="userinfo.wxewmimg==null||userinfo.wxewmimg==''?'static/images/morenheadimg.png':$HOST+userinfo.wxewmimg" />
                  </van-col>
                  <van-col span="8">
                      <van-uploader :after-read="updatewxewm" accept="image/*" multiple>
            ...
            <van-cell-group>
                ...
                <van-field v-model="userinfo.dictum" label="个性签名" type="textarea" placeholder="请输入我的宣言" />
...
export default {
    ...
    seavecard:function(){
        var user=JSON.parse(this.$cookie.getCookie("loginstate")).user;
        if(user==null||user!=this.userinfo.mobile){
            this.$router.push="/login";
            return;
        }
      this.$axios({
